...
Abstract class Database
{
    ...
    /**obtener el valor del para metro para el metodo prepare...
     * @param $value
     * @return string
     */
    protected function prepareGetType($value)
    {
    ...
    protected function setParam($types, $params)
    {
    ...
    protected function getRegNumber()
    {
    ...
    private function getNumRowsRequested()
    {
