...
/////fin del metodo getvar
     ...
     * @param bool $default
     * @param bool $onchange
     * @param bool $desabilita
     * @param bool $mandatory
     * @return string
     */
    public function dbComboBox($id, $query, $option, $value, $select = false, $default = false, $onchange = false, $desabilita = false, $mandatory = false)
    {
    ...
    /** crea un combobox a partir de un array asociativo
     * @param $id
     * @param $array
     * @param bool $select
     * @param bool $default
     * @return string
     */
    public static function arrayAsocCombo($id, $array, $select = false, $default = false){

        $option = array_keys($array); ///claves
        ...
        for ($i = 0; $i < count($option); $i++) {
            $combo .= '<option value="';
          //  $combo .= stripslashes($array[$option[$i]]);
            $value = $array[$option[$i]];
            $combo .= $value;
            $combo .= '"';
            if ($default == $value)
                $combo .= ' selected';
